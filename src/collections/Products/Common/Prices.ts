...
const getPriceGroup = (isVariation?: boolean): Field => {
  const GrossPrice = getPriceField('grossPrice', 'Gross Price', 'Giá Bán Gốc', true, isVariation)
  const NetPrice = getPriceField('netPrice', 'Net Price', 'Giá Bán Cuối', false, isVariation)
  return {
