...
const getCostsGroup = (isVariation?: boolean): Field => {
  const ProdCost = getCostField('productCost', 'Product Cost', 'Vốn Sản Phẩm', isVariation)
  const PackageCost = getCostField('packageCost', 'Package Cost', 'Vốn Bao Bì', isVariation)
  return {
